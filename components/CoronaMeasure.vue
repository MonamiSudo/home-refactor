  ...
  <section class="py-14">
    <div class="mx-auto max-w-6xl tab:w-11/12">
      ...
      <div class="mt-5 text-center sp:text-left sp:text-sp-base">
        ...
        <p class="sp:mt-4">ご自宅でも安心して施術を受けていただくことができます。</p>
        <p class="sp:mt-4">詳細につきましては、<a href="https://qohs.me/forsafety/" class="text-blue-600 underline hover:cursor-pointer inline-block" target="_blank">新型コロナウイルス感染予防の取り組みについて</a>をご覧ください。</p>
      </div>
    </div>
  </section>
</template>